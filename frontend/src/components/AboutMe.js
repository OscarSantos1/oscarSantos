...
const AboutMe = ({ setAnimate, animate }) => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row justify-around md:justify-between md:items-center h-[23%] md:h-[36%] md:min-h-[226px] lg:pl-2 md:pr-10 mt-3 md:mt-0">
      <p className="w-[85%] md:w-[55%] text-[#646464] text-[10px] 2xl:text-2xl lg:text-[16px] md:text-[14px]">
