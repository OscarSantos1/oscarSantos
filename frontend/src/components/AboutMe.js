...
const AboutMe = ({ setAnimate, animate }) => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row justify-around md:justify-between md:items-center h-[160px] md:h-[36%] md:min-h-[226px] lg:pl-2 md:pr-10 mt-3 md:mt-0 bg-lime-400">
      <p className="w-[85%] md:w-[55%] text-[#646464] text-[10px] sm:text-[12px] 2xl:text-2xl lg:text-[16px] md:text-[14px]">
      ...
      <div
        id="slider-frame"
        className="relative w-[40%] pt-[20%] sm:w-[30%] sm:pt-[15%] md:w-[40%] md:pt-[20%] lg:w-[34%] lg:pt-[17%]"
      >
        <div
